...
import { Plus, Trash2, Save, RefreshCw, Variable } from 'lucide-react'
    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <div className="section-header flex-1 mb-0 border-b-0">Variables</div>
        ...
        {envVars.length === 0 ? (
          <div className="border border-dashed border-muted-foreground/20 rounded-lg p-8 text-center">
            <Variable className="h-8 w-8 mx-auto text-muted-foreground/40 mb-3" />
